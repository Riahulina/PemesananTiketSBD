...
class PemesananController extends Controller
{
    ...
    public function index()
    {
        ...
        $pesanan = Pemesanan::with(['kereta', 'tiket'])
    ...
    public function show($kode_tiket)
    {
        ...
        $tiket = Tiket::where('kode_tiket', $kode_tiket)
            ->whereHas('pelanggan', function ($q) use ($email) {
                $q->where('email', $email);
            })
            ->firstOrFail();

        return view('pesanan.show', compact('tiket'));
    }
}
